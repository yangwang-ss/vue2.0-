<style>
	...
	div.zTreeDemoBackground {width:100%;height:463px;text-align:left;overflow: auto;}
	...
	.ztree li span.button {line-height:0; margin:0; width:16px; height:16px; display: inline-block; vertical-align:middle;
		...
		background-image:url("../../images/ztree/zTreeStandard.gif"); *background-image:url("../../images/ztree/zTreeStandard.gif")}
	...
	span.tmpzTreeMove_arrow {width:16px; height:16px; display: inline-block; padding:0; margin:2px 0 0 1px; border:0 none; position:absolute;
		...
		background-position:-110px -80px; background-image:url("../../images/ztree/zTreeStandard.gif"); *background-image:url("../../images/ztree/zTreeStandard.gif")}
...
<template>
	...
	<div class="ztree_content_wrap" v-if='treeDataSource.length>0'>
		<div class="zTreeDemoBackground left scroll">
			<ul class="ztree">
        ...
        ztreeItem:{
            ...
            `<li :class="liClassVal">
				...
				<a :class="aClassVal" @click='Func(model)' @contextmenu.prevent='cxtmenufunc(model)'>
					...
					<span class="node_name">{{model.label}}</span>
				</a>
