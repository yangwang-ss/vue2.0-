    ...
    <div class="ats-tree" v-clickoutside="handleCloseTree" ref="atsTree">
        <div class="ats-input" @mouseenter="hovering=true" @mouseleave="hovering=false">
            <div class="ats-input-single" v-if="!this.multiple">
                <i class="icon ivu-icon ivu-icon-ios-arrow-down ivu-select-arrow"
                    :class="{'is-reverse':treeVisible,'ivu-icon-ios-close':showCloseIcon}"
...
<style lang="scss">
	.ats-tree-node .ats-tree-node__content.is-checked .ats-tree-node__label::after{
		content: "√" !important;
	}
	.is-reverse{
