<template>
	<div id="imgLable">
		<h4 class="h41" style="cursor: auto;">图片标注人工质检</h4>
		<div class="row">
		...
		<table border="" cellspacing="0" cellpadding="0" id="tableForm">
			...
			<tr v-for="item in imgTableList">
				...
				<td class="check-more" @click="jumpRouter(item.id,item.batchId,item.projectName)">查看</td>
			</tr>
		</table>
		<!--分页插件-->
		<div id="page">
...
<script>
	export default {
		...
		methods: {
			...
			imgtableList() {
				var that = this;
				this.axios.post('appeal/appealList/4.do', {
