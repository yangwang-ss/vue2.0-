		...
		<div :class="objDataNull==null?'fixed':''">
			...
			<div class="view-content">
				...
				<div class="content">
					...
					<Row>
						<Col span="10">
						<Col span="24" class="content-spacing">
						<Col span="5" class="name-xs"> <span class="textLt">抽奖时间：</span>
						</Col>
						<Col class="information-xs"> {{computationsCallTime(appeaCusmentVo.抽奖时间)}}
						</Col>
						</Col>
						<Col span="24" class="content-spacing">
						<Col span="5" class="name-xs"> <span class="textLt">旺旺名：</span>
						</Col>
						<span class="information-xs">{{appeaCusmentVo.旺旺名}}</span>
						</Col>
						<Col span="24" class="content-spacing">
						<Col span="5" class="name-xs"> <span class="textLt">电话：</span>
						</Col>
						<span class="information-xs">{{appeaCusmentVo.电话}}</span>
						</Col>
						</Col>
						<Col span="14">
			...
			getDefaultLoad() {
				...
				this.axios.post("appeal/findAppeaDetail.do", {
					...
					if(res.data.code === "0") {
						...
						this.appeaCusmentVo = res.data.data.yxdqMap;
